...
class Solution {
    ...
    public int maxSubarraySumCircular(int[] A) {
        ...
        temp = temp + kadane(A);
        temp = temp == 0?-10000000:temp;
        
        System.out.println(temp + " " + kadMax);
        return Math.max(temp, kadMax);
    }
}